...
RUN apt-get update && \
	sudo apt-get --no-install-recommends --yes install build-essential ca-certificates g++ libfmt-dev libgit2-dev libsqlite3-dev libssl-dev meson ninja-build pkg-config python3 wget
