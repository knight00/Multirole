...
enum ExtraRule
{
	...
	EXTRA_RULE_CONCENTRATION_DUEL  = 0x4,
	EXTRA_RULE_BOSS_DUEL           = 0x8,
	EXTRA_RULE_BATTLE_CITY         = 0x10,
	EXTRA_RULE_DUELIST_KINGDOM     = 0x20,
	EXTRA_RULE_DIMENSION_DUEL      = 0x40,
	EXTRA_RULE_TURBO_DUEL          = 0x80,
	EXTRA_RULE_COMMAND_DUEL        = 0x100,
	EXTRA_RULE_DECK_MASTER         = 0x200,
	EXTRA_RULE_ACTION_DUEL         = 0x400,
	EXTRA_RULE_KCG_System          = 0x800,
	EXTRA_RULE_Field_System        = 0x1000,
	EXTRA_RULE_No_Shuffle          = 0x2000,
	EXTRA_RULE_OPPLP               = 0x4000,
	EXTRA_RULE_OPPHAND             = 0x8000
	////kdiy///////
};
